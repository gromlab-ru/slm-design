...
const documentationSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Business и API', link: '/level-2/domains/business' },
      { text: 'Factories и adapters', link: '/level-2/domains/factory-ports-adapters' },
      { text: 'Assemblies и среды', link: '/level-2/domains/assemblies' },
